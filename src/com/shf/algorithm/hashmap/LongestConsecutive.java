...
//            判断当前连续序列长度是否为最大
    ...
    public static void main(String[] args) {
        ...
        System.out.println(longestConsecutive.longestConsecutive3(nums1));
        System.out.println(longestConsecutive.longestConsecutive3(nums2));
    }
